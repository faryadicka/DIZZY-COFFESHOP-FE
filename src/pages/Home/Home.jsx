...
function Home() {
  ...
  return (
    <>
      {auth.authData?.token ? (
        <Navbar profile={auth.userData?.image_profile} />
      ) : (
        <NavbarHome />
      )}
              ...
              <div className="card-body">
                <div className="row justify-content-lg-between gap-2">
                  ...
                  <div className="col-md-3 column-info-second d-flex">
                    <img className="image-info" src={Location} alt="location" />
            ...
            <div className="card p-md-4 border-0">
              ...
              <div className="row-cols-auto">
                <ul className="list-group list-group-flush">
                  ...
                  <li className="list-group-item border-0">
                    <img src={Checklist} alt="check" /> Free member card with a
            ...
            <div className="card-body">
              <div className="row justify-content-lg-between">
                <div className="col-md-4">
                  <h2 className="card-title fw-bold">Check our promo today!</h2>
                ...
                <div className="col-md-2">
                  ...
                  {/* <Button type="warning" loading={false}>See Promo</Button> */}
                </div>
              </div>
            </div>
          </div>
