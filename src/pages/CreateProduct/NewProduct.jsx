...
import { createProductAxios } from "../../services/product";
...
function NewProduct() {
  ...
  const [imgDefault, setImageDefault] = useState(Default);
  ...
  const createForm = () => {
    ...
    if (form.start !== "") {
      body.append("start", form.start);
    }
    if (form.end !== "") {
      body.append("end", form.end);
    }
    if (form.image !== "") {
      body.append("image", form.image);
    }
    if (form.categoryId !== "") {
      body.append("categoryId", Number(form.categoryId));
    }
    return body;
  };
  ...
  return (
    <>
            ...
            <div className="col-md-4">
              <div className="row justify-content-center">
                <img
                  ...
                  alt="imageproduct"
                  className="rounded-circle cursor-image-products img-size-create"
                  onClick={(event) => {
              ...
              <div className="row mt-4">
                <button
                  ...
                  className="btn btn-dark py-3 rounded-4"
                >
                  Take a picture
                </button>
              </div>
              ...
              <div className="row mt-3">
                <button className="btn btn-dark rounded-4 py-3">Cancel</button>
              </div>
            </div>
      ...
      <ModalWarning
        showModal={showModal}
        message={createSuccess ? message.success : message.error}
        hideModal={() => {
          setShowModal(false);
        }}
      />
